    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('qism_detail_id')
                    ->label('Qism')
                ...
                TextColumn::make('santri.statussantri.status')
                    ->label('Status')
                    ->searchable(isIndividual: true),

                TextColumn::make('santri.statussantri.ket_status')
                    ->label('Ket Status')
                    ->searchable(isIndividual: true)
                    ->alignCenter(),

                TextColumn::make('santri.jenispendaftar')
                    ->label('Proses'),

                TextColumn::make('naik_ke_qism')
                    ->label('Qism >')
                    ->default(function (Model $record) {
                        ...
                        if ($cekdatats === 0) {
                            ...
                            $abbrkelas = QismDetail::where('id', $cekdatats->qism_detail_id)->first();

                            return ($abbrkelas->abbr_qism_detail);
                        }
                    }),

                TextColumn::make('naik_ke_kelas')
                    ->label('Naik Kelas')
                    ->default(function (Model $record) {
            ...
            ->defaultSort('qism_detail_id', 'kelas_id')
            ->groups([
                GroupingGroup::make('qism_detail.qism_detail')
                    ->titlePrefixedWithLabel(false)
            ])

            ->defaultGroup('qism_detail.id')
            ->filters([
